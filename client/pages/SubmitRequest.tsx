  ...
  const submit = async (event: FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your comic was submitted successfully for review.",
      });
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_320px]">
          ...
          >
            ...
            <label
              ...
              onDrop={onDrop}
              className={`mb-8 flex cursor-pointer flex-col items-center justify-center rounded-[26px] border-2 border-dashed px-6 py-10 text-center transition ${
                dragging
                  ? "border-[#3157d5] bg-blue-50"
                  : "border-black/15 bg-black/[0.02] hover:border-[#3157d5]/60"
              }`}
            >
              <input
                type="file"
            ...
            <div className="mt-8 flex justify-end">
              <button
                ...
                className="flex items-center gap-2 rounded-full bg-[#3157d5] px-6 py-3 text-sm font-black text-white shadow-lg transition hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-50"
              >
